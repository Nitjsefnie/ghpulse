...
def _guest_denied(request: Request) -> Response | None:
    ...
    # Aggregate GitHub data is public and may be filtered by repository. Only
    # future export/raw-data routes are restricted for the guest identity.
...
def _session_denied(request: Request) -> Response | None:
    ...
    # Guests may access the public aggregate endpoints, including their range
    # and repository filters. Export/raw-data routes remain restricted above.
